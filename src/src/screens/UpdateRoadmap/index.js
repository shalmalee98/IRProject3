...
const {roadmap, papers} = route?.params;
//console.log(roadmap.levels.size);
  ...
  return (   
    ...
    <View style={[styles.seContainer, {marginRight: 20}]}>
      ...
      <View style={[styles.seContainer]}>
        ...
        <View style={styles.createButton}><TouchableOpacity onPress={() => handleNavigation('updateRoadmap', label, level, TAGS, papers)}>
        <LinearGradient
        start={{ x: 0, y: 0 }}
        end={{x: 1, y: 1 }}
