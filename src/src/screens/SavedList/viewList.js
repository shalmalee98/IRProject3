...
export function viewList({route, navigation}) {
  ...
  return (
    ...
    <ScrollView
        ...
        <View style={styles.courseRightContainer}>
          <Text numberOfLines={2} ellipsizeMode="tail" style={styles.courseInfo} onPress={()=> handleNavigation('viewPdf', dirPath+'/'+file.name)}>
           {file.name}
          </Text>    
          </View> 
        </View>
